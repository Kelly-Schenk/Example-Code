...
#--------------------------------------------------------------------------------------------------------------------#
  ...
  #-------Assessing Data-------#
    boxplot(nonsyn$adult_mass,
            xlab = "Adult Mass (g)",
            col = "lightgreen",
            main = "Nonsyn Distribution of Adult Mass") #has outliers, but will not correct for them
    boxplot(syn$adult_mass,
            xlab = "Adult Mass (g)",
            col = "lightgreen",
            main = "Syn Distribution of Adult Mass") #no outliers
    boxplot(nonsyn$gestation,
            xlab = "Gestation (in days)",
            col = "lightyellow",
            main = "Nonsyn Distribution of Gestation") #no outliers
    boxplot(syn$gestation,
            xlab = "Gestation (in days)",
            col = "lightyellow",
            main = "Syn Distribution of Gestation") #no outliers
    boxplot(nonsyn$litters_annually,
            xlab = "Litters Annually (in number of offspring per litter)",
            col = "blue",
            main = "Nonsyn Distribution of Number of Offspring") #has 1 outlier, but will not correct for it
    boxplot(syn$litters_annually,
            xlab = "Litters Annually (in number of offspring per litter)",
            col = "blue",
            main = "Syn Distribution of Number of Offspring") #has 2 outliers, but will not correct for it
    boxplot(nonsyn$litter_size,
            xlab = "Litter Size (in number of litters per year)",
            col = "deeppink",
            main = "Nonsyn Distribution of Number of Litters per Year") #no outliers
    boxplot(syn$litter_size,
            xlab = "Litter Size (in number of litters per year)",
            col = "deeppink",
            main = "Syn Distribution of Number of Litters per Year") #has 1 outlier, but will not correct for it
